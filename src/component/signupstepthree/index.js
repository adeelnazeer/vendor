                    ...
                    <div className="col-5 pd-70 bgwhite bd-rad-8">
                        <div className="txt-align-cntr">
                            ...
                            <div className="d-flex flex-column txt-align-start pd-top-40">
                                ...
                                <input className="signloginput bd-rad-8" placeholder="example@gmail.com"></input>
                            </div>
                            <div className="d-flex flex-column txt-align-start pd-top-40">
                                <p>Add your identity verification documents such as passport,driver's licence,etc</p>
                            </div>
                            <div className="">
                                <button className="signlogbtn bggrey">UPLOAD FILE</button>
                            </div>
                            <div className="pd-top-40">
                                <button className="signlogbtn bgdarkgrey">REIGISTER AS A VENDOR</button>
                            </div>
